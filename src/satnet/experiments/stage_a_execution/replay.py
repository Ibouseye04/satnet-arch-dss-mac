...
from .artifact_contract import bind_plan_run, validate_run_output
...
def execute_replay(
    *, repo_root: Path, plan: dict[str, Any], authorization_hash: str,
    ...
    with campaign_lock(replay_root, plan["plan_hash"]):
        ...
        for plan_run in plan["runs"]:
            ...
            with per_run_lock(replay_root, plan_run["run_key"], plan_run["run_record_hash"]):
