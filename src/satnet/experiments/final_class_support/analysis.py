...
def augmentation_contract(proposal_rows: Sequence[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "stage_a": {
            "status": "SUPERSEDED_BY_EXACT_DISCOVERY_CONTRACT_PROPOSAL_V1",
            "proposal_reference": "artifacts/stage_a_discovery_contract_proposal/stage_a_contract_proposal.json",
            "proposal_inventory_reference": "artifacts/stage_a_discovery_contract_proposal/stage_a_proposal_inventory.json",
            "proposal_status": "NOT_FROZEN",
            "simulation_authorized": False,
            "design_count": 30,
            ...
            "partition_allocation": {"development": 20, "validation": 5, "sealed_holdout": 5},
            ...
            "acceptance_scope": "Discovery criteria only; final classification acceptance gates do not apply to Stage A.",
            "final_corpus_membership": "EXCLUDED_FROM_PRIMARY_FINAL_CLASSIFICATION_CORPUS",
            "permitted_influence_on_stage_b": [
                "Stage A development and validation boundary-margin and neighborhood evidence.",
                "Observed storage and runtime for planning.",
            ],
            "sealed_holdout_rule": "The five-design holdout cannot influence Stage B bounds, regions, density, sample size, split allocation, seeds, or gates and remains sealed until a complete Stage B contract is frozen, independently audited, and hash-recorded.",
            "prohibited_adaptation": "No silent design, seed, partition, criterion, gate, target, or holdout change. Stage B requires a separately reviewed, frozen, and audited contract.",
        },
        "stage_b": {
        ...
        "target_schema_reference": "Frozen eight-target schema and unchanged 0.80 thresholds; margin equals failure-adjusted minimum overall service fraction minus 0.80, and zero is non-breach.",
        "final_corpus_membership": {
            "primary_final_classification_corpus": "Frozen original corpus plus future frozen Stage B corpus.",
            "stage_a": "Discovery-only and excluded from primary final classification acceptance.",
            "expected_if_stage_b_remains_90_designs": {"designs": 190, "runs": 950},
        },
        "class_support_gates": {
            "applicability": "Primary final classification corpus: frozen original corpus plus future frozen Stage B corpus; Stage A is excluded.",
            ...
            "design_class_definition": "A five-realization design counts once by majority class and never toward both class minima.",
            "observed_boundary_definition": "Margins straddle zero, or at least two realizations have absolute margin <= 0.05.",
            "distinct_margin_definition": "Signed margin quantized to 0.000001 using round-half-even before uniqueness counting.",
